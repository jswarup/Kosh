...
impl< 'a, T, I: Into< U32>> Index< I> for Arr< 'a, T>
{
    type Output = T;
...
impl< 'a, T, I: Into< U32>> IndexMut< I> for Arr< 'a, T>
{
    #[inline]
...
impl< 'a> Arr< 'a, U8>
{
    ...
    pub fn	ParseI32( &self) -> i32
    {
        self.AsStr().parse::< i32>().unwrap()
    }

    pub fn	ParseF32( &self) -> f32
    {
        self.AsStr().parse::< f32>().unwrap()
    }
}
