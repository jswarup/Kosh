...
impl KoshApp
{
    ...
    {
        // Apply crisp dark theme visuals matching Frieze (Catppuccin Mocha / VS Code Dark)
...
impl eframe::App for KoshApp
{
    ...
    {
        // 1. Top Header & Tab Bar Panel (Height & Styling matching Frieze)
        Panel::top( "top_panel")
            .frame(
                Frame::new()
        ...
        // 2. Bottom Status Bar Panel (Height: 24px, #11111b matching Frieze)
        ...
        // 3. Left Sidebar Explorer Panel (Width: 260px, #181825 matching Frieze)
        ...
        // 4. Central Document Viewport Area (#1e1e2e matching Frieze)
